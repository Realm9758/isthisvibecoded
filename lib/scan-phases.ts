...
export const SCAN_PHASES: ScanPhase[] = [
  ...
  { id: 'vibe',       label: 'Browser Code & Secrets',  detail: 'Following bounded same-origin scripts, preloads, and chunk references for material secrets, provider configuration, routes, and later module inputs…' },
  ...
  { id: 'cors',       label: 'CORS Policy',             detail: 'Testing null/untrusted origins, browser preflights, credentialed reflection, and Origin cache variation on selected API routes…' },
  { id: 'headers',    label: 'Security Headers',        detail: 'Auditing effective CSP, HSTS, framing, MIME, referrer, and permissions policies, then sampling discovered routes for drift…' },
  ...
  { id: 'admin',      label: 'Admin Access',            detail: 'Prioritising discovered management routes, then checking bounded common paths for privileged-interface evidence rather than treating a login page as exposure…' },
  ...
  { id: 'dirlist',    label: 'Directory Listing',       detail: 'Checking directories learned from public routes plus bounded common asset and backup paths for real index listings…' },
  ...
  { id: 'serverstatus', label: 'Diagnostic Consoles', detail: 'Checking bounded Apache, nginx, PHP-FPM, and Spring operational endpoints with product-specific content validation…' },
  ...
  { id: 'graphql',    label: 'GraphQL Introspection',   detail: 'Prioritising discovered GraphQL routes, then sending a bounded schema query and requiring structured schema data…' },
  { id: 'apidocs',    label: 'API Documentation',       detail: 'Prioritising discovered documentation routes, then requiring structured OpenAPI, Swagger, or ReDoc evidence at bounded paths…' },
  ...
  { id: 'ratelimit',  label: 'Rate-Limit Signals',        detail: 'Final intentional rapid series: sending six response-serialised requests to one owner-approved public API route and recording 429, Retry-After, or standard rate-limit headers…' },
